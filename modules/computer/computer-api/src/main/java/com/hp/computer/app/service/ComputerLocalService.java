...
/**
 * Provides the local service interface for Computer. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ComputerLocalServiceUtil
...
public interface ComputerLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ComputerLocalServiceUtil} to access the computer local service. Add custom service methods to {@link com.hp.computer.app.service.impl.ComputerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Indexable(type = IndexableType.DELETE)
	public Computer deleteComputerModel(long computerId)
	...
	*/
	...
	@Indexable(type = IndexableType.REINDEX)
	public Computer updateComputerModel(Computer computer)
		throws PortalException;
}